...
Public Class FormRegistroLecturaSecu
    ...
    Private Sub Print8(ByVal silent As Boolean)
        ...
        print1.DrawText("Si Ud. cancelo en caja meses pendientes, desestime valor de fact. pendientes.", 0.055, 3.4)
        'AREA PIE#2
        print1.FontBold = False
        print1.FontSize = 6.3
        If (txtCuenta.Text.Length = 0 Or String.IsNullOrEmpty(txtCuenta.Text)) Then 'AVISO SEGUN REQ 09-11-2020 PARA CLANDESTINOS....
            print1.DrawText("NOTITIFCACION PARA APERSONARSE POR SeLA ORURO (OFICINA GESTIÓN TRÁMITES)", 0.06, 3.6 - py)
            print1.DrawText("A REGULARIZAR SU INSTALACION CLANDESTINA,   ", 0.06, 3.7 - py)
            print1.DrawText("A FIN DEEVITAR EL RETIRO DESDE LA MATRIZ.   GRACIAS!...", 0.06, 3.8 - py)
        Else 'AVISO PIE#2 GENERAL PARA TODAS LAS BOLETAS DE PREAVISO.... (PREDETERMINADO)
            ...
            print1.DrawText("corrección  antes  del  10  del siguiente  mes.   GRACIAS!...", 0.06, 3.8 - py)
        End If
